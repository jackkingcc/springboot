package home.jackking.storage.service;

import home.jackking.storage.StorageException;
import home.jackking.storage.StorageFileNotFoundException;
import home.jackking.storage.StorageProperties;
...
public class FileSystemStorageService implements StorageService {
    ...
    public void init() {
        try {
            ...
            throw new StorageException("can't init root path",e);
        }
    }
